...
export const DEFAULT_WEDDING_CONFIG: WeddingConfig = {
  ...
  images: {
    ...
    rsvpHeader: "",
    floralDivider: "",
    coupleOverlay: "/images/pareja_overlay_ivory.png",
  },
  polaroids: [
  ...
  secondConfirmationDeadline: "12 de septiembre",
  secondConfirmationImage: "/images/invitacion_1.webp",
  ...
  showCoupleOverlay: true,
  coupleOverlayX: 50,
  coupleOverlayY: 65,
  coupleOverlayScale: 1.0,
};
